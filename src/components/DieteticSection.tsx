  ...
  return (
    <section className="container flex flex-col gap-16 pt-12">
      ...
      <div className="grid md:grid-cols-[45%,1fr] gap-8">
        <div>
          <div className="max-md:hidden w-full h-[600px] bg-[linear-gradient(90deg,rgba(0,0,0,0)80%,rgba(255,255,255,1)100%),url('/dynamique-step.jpg')] bg-cover bg-center rounded-l-lg" />
          <div className="md:hidden w-full h-[400px] bg-[linear-gradient(180deg,rgba(0,0,0,0)80%,rgba(255,255,255,1)100%),url('/dynamique-step.jpg')] bg-cover bg-center rounded-t-lg" />
        </div>
