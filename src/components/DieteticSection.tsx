...
export default function DieteticSection() {
  return (
    <section className="container flex flex-col gap-16 pt-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[45%,1fr] gap-8 pb-16">
        <div>
          <div className="max-md:hidden w-full h-[600px] bg-[linear-gradient(90deg,rgba(0,0,0,0)80%,hsl(var(--background))100%),url('/dynamique-step.jpg')] bg-cover bg-center rounded-l-xl" />
          <div className="md:hidden w-full h-[400px] bg-[linear-gradient(180deg,rgba(0,0,0,0)80%,hsl(var(--background))100%),url('/dynamique-step.jpg')] bg-cover bg-center rounded-t-lg" />
        </div>
        <div className="">
          <p className="text-lg">
